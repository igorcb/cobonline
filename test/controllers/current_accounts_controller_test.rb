...
class CurrentAccountsControllerTest < ActionController::TestCase
  ...
  test "should create current_account" do
    assert_difference('CurrentAccount.count') do
      post :create, current_account: { city_id: @current_account.city_id, cost_id: @current_account.cost_id, date_ocurrence: @current_account.date_ocurrence, historic: @current_account.historic, price: @current_account.price, type_launche: @current_account.type_launche }
    end
  ...
  test "should update current_account" do
    patch :update, id: @current_account, current_account: { city_id: @current_account.city_id, cost_id: @current_account.cost_id, date_ocurrence: @current_account.date_ocurrence, historic: @current_account.historic, price: @current_account.price, type_launche: @current_account.type_launche }
    assert_redirected_to current_account_path(assigns(:current_account))
  end
